<template>
  <div class='fileUpload' v-loading='loading'>
    ...
    <el-table :data='tableData' style='width: 100%'>
      <el-table-column prop='username' label='上传者' width='180'></el-table-column>
      <el-table-column prop='upload_time' label='上传时间' :formatter='formatterTime' width='280'></el-table-column>
      <el-table-column prop='files_description' label='文件描述' :formatter='formatterDescription'></el-table-column>
      <el-table-column label='操作' width='80'>
        <template slot-scope='scope'>
          <el-dropdown trigger="click">
            <span class='el-dropdown-link' style='cursor:pointer;color:#409eff'>操作</span>
    ...
    <div class="block">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="currentPage" :page-sizes="[2, 5, 10, 20, 30]" :page-size="pageSize" layout="total,sizes, prev, pager, next" :total="total"></el-pagination>
    </div>
