...
<template>
  <div class="login" v-loading='domLoading'>
    <img src="~@/assets/images/footballCourt.jpg" alt="" style="display:none" id="lazy_load_img">
    <div class="textBox">
      <h2>Football Club</h2>
      <div>
        <img src="~@/assets/images/realMadrid.jpg" alt="">
        <p>Hala Madrid</p>
      </div>
      <div>
        <img src="~@/assets/images/manchesterUnited.jpg" alt="">
        <p>once a red always a red</p>
      </div>
      <div>
        <img src="~@/assets/images/juventus.jpg" alt="">
        <p>FORZA JUVEN</p>
      </div>
      <div>
      ...
      <div>
        <img src="~@/assets/images/dortmund.jpg" alt="">
        <p>Heja BVB</p>
      </div>
      <div>
        <img src="~@/assets/images/hengda.jpg" alt="">
        <p>广州未赢够</p>
      </div>
      <div>
        <img src="~@/assets/images/fuli.jpg" alt="">
        <p>年富力强</p>
      </div>
    </div>
...
<style lang="stylus" scoped>
  .login {
    ...
    &:before {
      background-image: url('~@/assets/images/footballCourt.jpg');
