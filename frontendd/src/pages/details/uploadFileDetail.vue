<template>
  <div class="uploadFileDetail" ref="uploadFileDetail">
    <div class="back_btn">
      <el-button type='primary' size='mini' @click='$router.back()'>返回</el-button>
    </div>
    <waterfalls v-if="files && files.length>0" :files='files' :column='column' :fileWidth='fileWidth' :defaultImg='defaultImg'></waterfalls>
  </div>
</template>
