<template>
  <div class="account" v-loading="loading">
    <div class="account-left" v-show="!loading">
      <p class="account-header">账号信息</p>
      <div class="account-content">
        <el-row>
          <el-col :span="4">
            <div class="grid-content bg-purple inputClass">账号名称</div>
          </el-col>
          <el-col :span="20">
            <div class="grid-content bg-purple-light">
              <el-input placeholder="请输入账号名称" size="mini" suffix-icon="el-icon-edit-outline"
      ...
      <div class="account-content">
        <el-row>
          ...
          <el-col :span="20">
            <div class="grid-content bg-purple-light">
              <el-input placeholder="请输入邮箱" size="mini" suffix-icon="el-icon-message"
      ...
      <div class="account-content">
        <el-row>
          ...
          <el-col :span="20">
            <div class="grid-content bg-purple-light">
              <el-switch v-model="userInfo.is_deleted" active-color="#13ce66" inactive-color="#ff4949" :active-value="0"
                         :inactive-value="1" @change="deleteAccount" disabled></el-switch>
            </div>
          </el-col>
        </el-row>
      </div>
    ...
    <div class="account-right" v-show="!loading">
      ...
      <div class="account-content">
        <el-row>
          ...
          <el-col :span="20">
            <div class="grid-content bg-purple-light">
              <el-upload :action="actionUrl()" :limit="1" list-type="picture-card"
...
<script>
  ...
  import {formatterTime,setLocalStorage} from "../../tools";
  ...
  export default {
    ...
    methods:{
      actionUrl(){
        return process.env.NODE_ENV === 'development' ? `http://localhost:8081/api/upload/image?uid=${this.user.uid}`:`http://120.27.243.127:80/api/upload/image?uid=${this.user.uid}`;
      },
      getUserInfo(){
        this.loading=true;
      ...
      beforeAvatarUpload(file){
        ...
        if(isImage){
          this.$tips({
            type:'error',
            message:'只能上传GIF, PNG, JPEG, JPG等格式的图片'
          });
          return false;
        }
        if(!isLt2M){
