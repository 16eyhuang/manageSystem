...
-->
<template>
  <div class="waterfalls" ref="waterfalls">
    <div class="waterfalls-items" v-for="(item,index) in files" :key='index'>
      <img :src="defaultImg" :data-src='item' :width="fileWidth" :height="imgHeight[index]">
    </div>
  </div>
</template>
