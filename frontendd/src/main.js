...
const filterUrl = [`${process.env.BASE_URL}/api/log/insertOperationLog`, `${process.env.BASE_URL}/api/user/userLoginCount`, `${process.env.BASE_URL}/api/spider/hitokoto`, 'https://api.github.com/repos/Gavinli123/StuSyllabus/commits', 'https://api.github.com/repos/xypecho/vue-full-stack-project/commits', `${process.env.BASE_URL}/api/user/md5Password`, `${process.env.BASE_URL}/api/user/userInfo`,'https://api.github.com/repos/vuejs/vue/commits', `${process.env.BASE_URL}/api/todo/getUserTodo`, `${process.env.BASE_URL}/api/todo/addTodo`, `${process.env.BASE_URL}/api/todo/deleteTodo`]; // 不需要拦截的请求的url
